 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.bank.impl.DeviceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeviceImpl extends TransactionInitiatorImpl implements Device {
	...
	public EList<Token> getTokens() {
		return (EList<Token>)eDynamicGet(BankPackage.DEVICE__TOKENS, BankPackage.Literals.DEVICE__TOKENS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BankPackage.DEVICE__TOKENS:
